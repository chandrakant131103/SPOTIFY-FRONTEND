...
export default function Auth({ setUser }) {
    ...
    return (
        <div style={{ display: 'flex', height: '100vh', width: '100vw', background: '#000' }}>
            ...
            <div style={{ flex: '0 0 450px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#070707', padding: '40px', borderLeft: '1px solid rgba(255,255,255,0.05)' }}>
                <form onSubmit={handleSubmit} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div style={{ marginBottom: '20px' }}>
                        <h2 style={{ fontSize: '36px', color: '#fff', fontWeight: '900', letterSpacing: '-1px' }}>{isLogin ? 'Welcome Back' : 'Join Pulse'}</h2>
